...
!(function (n) {
    ...
    function b(t, e, n, a) {
        var r = [],
            o = 0,
            i = e.length;
        if (void 0 !== a) for (; o < i; o++) t[e[o]] && t[e[o]][n] && r.push(t[e[o]][n][a]);
            ...
            for (
                f.append(H(e.nTHead).clone()).append(H(e.nTFoot).clone()),
                    ...
                    f.find("thead th, thead td").each(function () {
                        var t = ct(e, this, !0, !1);
                        t ? ((this.style.width = t), s && H(this).append(H("<div/>").css({ width: t, margin: 0, padding: 0, border: 0, height: 1 }))) : (this.style.width = "");
                    }),
                    n = 0;
                n < u.length;
                n++
    ...
    function Fe(t, e) {
        return (t = null != t ? t.toString().toLowerCase() : ""), (e = null != e ? e.toString().toLowerCase() : ""), t.localeCompare(e, navigator.languages[0] || navigator.language, { numeric: !0, ignorePunctuation: !0 });
    }
    var l = V.ext.type,
        Ne =
